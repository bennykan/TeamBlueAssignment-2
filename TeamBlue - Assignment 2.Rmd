...
The dataset that we have has labelled data as we have the target value in the last column. In order to create a unlabelled dataset for our report we decided to remove this column along with the "ID" column as it has no importance.
...
######Billing Amount & Payment Amount for the same month
Lets explore the distribution of the Billing Amount and the Payment amount with respect to the month.

```{r, message=FALSE,warning=FALSE}
p12 = ggplot(data, aes(data$BILL_AMT1)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Bill Amount")+scale_y_continuous("Obs.")
p24 = ggplot(data, aes(data$PAY_AMT1)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Payment Amount")+scale_y_continuous("Obs.")
grid.arrange(p12,p24,nrow=1,top = "SEPTEMBER 2015")
```

```{r, message=FALSE,warning=FALSE}
p13 = ggplot(data, aes(data$BILL_AMT2)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Bill Amount")+scale_y_continuous("Obs.")
p25 = ggplot(data, aes(data$PAY_AMT2)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Payment Amount")+scale_y_continuous("Obs.")
grid.arrange(p13,p25,nrow=1,top = "AUGUST 2015")
```


```{r, message=FALSE,warning=FALSE}
p14 = ggplot(data, aes(data$BILL_AMT3)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Bill Amount")+scale_y_continuous("Obs.")
p26 = ggplot(data, aes(data$PAY_AMT3)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Payment Amount")+scale_y_continuous("Obs.")
grid.arrange(p14,p26,nrow=1,top = "JULY 2015")
```

```{r, message=FALSE,warning=FALSE}
p15 = ggplot(data, aes(data$BILL_AMT4)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Bill Amount")+scale_y_continuous("Obs.")
p27 = ggplot(data, aes(data$PAY_AMT4)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Payment Amount")+scale_y_continuous("Obs.")
grid.arrange(p15,p27,nrow=1,top = "JUNE 2015")
```

```{r, message=FALSE,warning=FALSE}
p16 = ggplot(data, aes(data$BILL_AMT5)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Bill Amount")+scale_y_continuous("Obs.")
p28 = ggplot(data, aes(data$PAY_AMT5)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Payment Amount")+scale_y_continuous("Obs.")
grid.arrange(p16,p28,nrow=1,top = "MAY 2015")
```

```{r, message=FALSE,warning=FALSE}
p17 = ggplot(data, aes(data$BILL_AMT6)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Bill Amount")+scale_y_continuous("Obs.")
p29 = ggplot(data, aes(data$PAY_AMT6)) + geom_histogram(binwidth = 5000,colour="black",fill="white")+  scale_x_continuous("Payment Amount")+scale_y_continuous("Obs.")
grid.arrange(p17,p29,nrow=1,top = "APRIL 2015")
```
...
```{r, message=FALSE,warning=FALSE}
p18 = ggplot(data, aes(,data$BILL_AMT1)) + geom_boxplot(fill = "white")+ scale_y_continuous("Billing Amount")+scale_x_continuous("")
p30 = ggplot(data, aes(,data$PAY_AMT1)) + geom_boxplot(fill = "white")+  scale_y_continuous("Payment Amount")+scale_x_continuous("")
grid.arrange(p18,p30,ncol=2,top="SEPTEMBER 2005")
```

```{r, message=FALSE,warning=FALSE}
p19 = ggplot(data, aes(,data$BILL_AMT2)) + geom_boxplot(fill = "white")+  scale_y_continuous("Billing Amount")+scale_x_continuous("")
p31 = ggplot(data, aes(,data$PAY_AMT2)) + geom_boxplot(fill = "white")+  scale_y_continuous("Payment Amount")+scale_x_continuous("")
grid.arrange(p19,p31,ncol=2,top="AUGUST 2005")
```

```{r, message=FALSE,warning=FALSE}
p20 = ggplot(data, aes(,data$BILL_AMT3)) + geom_boxplot(fill = "white")+  scale_y_continuous("Billing Amount")+scale_x_continuous("")
p32 = ggplot(data, aes(,data$PAY_AMT3)) + geom_boxplot(fill = "white")+  scale_y_continuous("Payment Amount")+scale_x_continuous("")
grid.arrange(p20,p32,ncol=2,top="JULY 2005")
```

```{r, message=FALSE,warning=FALSE}
p21 = ggplot(data, aes(,data$BILL_AMT4)) + geom_boxplot(fill = "white")+  scale_y_continuous("Billing Amount")+scale_x_continuous("")
p33 = ggplot(data, aes(,data$PAY_AMT4)) + geom_boxplot(fill = "white")+  scale_y_continuous("Payment Amount")+scale_x_continuous("")
grid.arrange(p21,p33,ncol=2,top="JUNE 2005")
```

```{r, message=FALSE,warning=FALSE}
p22 = ggplot(data, aes(,data$BILL_AMT5)) + geom_boxplot(fill = "white")+  scale_y_continuous("Billing Amount")+scale_x_continuous("")
p34 = ggplot(data, aes(,data$PAY_AMT5)) + geom_boxplot(fill = "white")+  scale_y_continuous("Payment Amount")+scale_x_continuous("")
grid.arrange(p22,p34,ncol=2,top="MAY 2005")
```

```{r, message=FALSE,warning=FALSE}
p23 = ggplot(data, aes(,data$BILL_AMT6)) + geom_boxplot(fill = "white")+  scale_y_continuous("Billing Amount")+scale_x_continuous("")
p35 = ggplot(data, aes(,data$PAY_AMT6)) + geom_boxplot(fill = "white")+  scale_y_continuous("Payment Amount")+scale_x_continuous("")
grid.arrange(p23,p35,ncol=2,top="APRIL 2005")
```
...
kmeans.result <- kmeans(df, centers=7,nstart = 20)
